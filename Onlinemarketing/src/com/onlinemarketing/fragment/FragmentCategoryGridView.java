...
import com.onlinemarketing.adapter.HomePageGridViewAdapter;
...
public class FragmentCategoryGridView extends Fragment implements OnItemClickListener,
	 ...
	 */
	public static FragmentCategoryGridView newInstance(int sectionNumber) {
		FragmentCategoryGridView fragment = new FragmentCategoryGridView();
